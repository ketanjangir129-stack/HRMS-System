        ...
        <>
            ...
            <div className="dashboard-row">
                ...
                <div className="bg-surface rounded-2xl p-4 sm:p-6 shadow-md">
                    <h2 className="text-xl sm:text-2xl font-semibold text-ink mb-4 sm:mb-6">
                        Quick Find
                    </h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-3 gap-4 sm:gap-6">
                        <div className="flex flex-col items-center cursor-pointer" onClick={gotoEmployees}>
                            ...
                            <p className="mt-2 text-center text-xs sm:text-sm font-medium text-ink-muted">
                                Employees
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center cursor-pointer" onClick={gotoSalary}>
                            <TbMoneybag className="text-4xl p-3 rounded-xl bg-surface-muted text-ink-subtle" />
                            <p className="mt-2 text-center text-xs sm:text-sm font-medium text-ink-muted">
                                Salary
                            </p>
                        </div>
