                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        placeholder="********"
                                        className="w-full h-12 pl-4 pr-12 rounded-xl border border-slate-300 bg-white focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition"
                                    />
